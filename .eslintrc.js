module.exports = {
  ...
  rules: {
    ...
    'key-spacing': [2, {// 关键字前后强制执行一致的间距
      'beforeColon': false, 
      'afterColon': true
    }],
    'keyword-spacing': [2, {//对象字面量中冒号的前后空格
      'before': true,
      'after': true
    }],
    ...
    'no-new-wrappers': 0,//杜绝使用String，Number以及Boolean与new操作
    ...
    'no-shadow-restricted-names': 2,//严格模式中规定的限制标识符不能作为声明时的变量名使用(NaN，Infinity，undefined,eval和arguments等)
